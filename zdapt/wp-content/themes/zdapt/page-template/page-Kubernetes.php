...
<section class="ex-con kuber-con" style="background-image : url(<?php bloginfo('template_directory'); ?>/images/k1.jpg);">
    <div class="container">
        <div class="row">
...
if( have_rows('expert_consulting_bottom_list') ):
    ...
    while( have_rows('expert_consulting_bottom_list') ) : the_row();
        ...
        // Do something...
        ?>
          <li data-wow-duration="2s" style="height : auto;">
...
<section class=" kuber-list"  style="background-image : url(<?php bloginfo('template_directory'); ?>/images/k2.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
