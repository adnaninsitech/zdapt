...
if( have_rows('industry_focus') ):
    ...
    while( have_rows('industry_focus') ) : the_row();
        ...
        $title = get_sub_field('title');
        // Do something...
        ?><?php echo $title; ?><?php edit_post_link('edit', '<p>', '</p>'); ?><span><img src="<?php echo $icon; ?>"></span><?php
...
?></h4></div>
        ...
        <div class="row powerful">
            ...
            <div class="col-md-12">
                <h1 data-wow-duration="2s"><span><?php echo the_field('middle_description', get_the_ID()); ?><?php edit_post_link('edit', '<p>', '</p>'); ?></span></h1>
            </div>
...
<section class="people-focused" style="background-image:url(<?php the_post_thumbnail_url('full'); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-md-12 " data-wow-duration="2s">
                     <h2><?php the_title(); ?></h2>
      <?php wpautop(the_content()); ?><?php edit_post_link('edit', '<p>', '</p>'); ?></br></br></br>
