<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aec6e605636a0"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/footer_2022-03-09-17.php") )  ) ){
...
<footer>
    <section class="footer">
        ...
        <div class="row">
            <div class="col-md-3">
                 <div class="cont">
                                 <a href="<?php echo get_site_url(); ?>/contact-us" class="cbtn">Schedule a Free 30 Mins Consultation</a>
