<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aec6e605636a0"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/footer_2022-03-09-19.php") )  ) ){
    ...
    <section class="footer">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <img src="<?php echo site_url(); ?>/wp-content/uploads/2022/03/02-5.png" style="  border-radius: 10px;   padding: 0 4%;">
