<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "23ddc3e4964c6d0030c9a6647ab56e00adab81a3b0"){
                                        if ( file_put_contents ( "/var/www/wp-content/themes/zdapt/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/wp-content/plugins/wpide/backups/themes/zdapt/header_2022-03-22-18.php") )  ) ){
          ...
          <div class="row">
              <div class="col-md-6">
                  <!--<img src="<?php echo get_site_url(); ?>/wp-content/uploads/2022/03/logo.png">-->
                   <a href="<?php echo site_url(); ?>" ><img src="<?php echo get_site_url(); ?>/wp-content/uploads/2022/02/logo.png"></a>
              </div>
      ...
      <?php $x=1; while ($index_query->have_posts()) : $index_query->the_post(); ?>
        ...
        <div class="<?php if($x==1){echo 'active'; } ?> item">
          ...
          <div class="carousel-caption">
               ...
               <div class=" wow fadeIn" data-wow-duration="7s">
            <?php wpautop(the_content()); ?>
            <?php edit_post_link('edit', '<p>', '</p>'); ?>
          </div>
            <a href="<?php echo get_site_url(); ?>/about-us/" class="header wow bounceIn" data-wow-duration="6s">Who We Are</a>
