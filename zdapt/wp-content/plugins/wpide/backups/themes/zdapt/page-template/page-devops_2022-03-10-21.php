<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aec92637412ec"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/page-template/page-devops.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/page-template/page-devops_2022-03-10-21.php") )  ) ){
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="slid">
            ...
            <img  class="wow fadeInDown" data-wow-duration="2s" src="<?php echo get_sub_field('img'); ?>">
