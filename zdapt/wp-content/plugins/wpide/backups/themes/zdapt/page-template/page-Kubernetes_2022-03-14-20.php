<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aecc07a13f087"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/page-template/page-Kubernetes.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/page-template/page-Kubernetes_2022-03-14-20.php") )  ) ){
...
<section class="ex-adop-list" style="background-image : url(<?php echo the_field('bg_banner'); ?>);">
    <div class="container">
           <div class="row why">
            <div class="col-md-12">
                <ul>
