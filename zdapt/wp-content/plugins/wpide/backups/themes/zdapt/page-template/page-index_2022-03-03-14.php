<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aec1298c2b153"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/page-template/page-index.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/page-template/page-index_2022-03-03-14.php") )  ) ){
   ...
   $x=1; while( have_rows('help_list') ) : the_row();
        ...
        ?>
          ...
          <li class=" wow fadeInDown" data-wow-duration="<?php echo $x; ?>s">
                ...
                <a href="<?php echo $link; ?>" class="header wow bounceIn" data-wow-duration="6s">Learn More</a>
            </div>
                        </li>
...
<?php while ($index_query->have_posts()) : $index_query->the_post(); ?>
 ...
 <section class="home-last-section">
     <div class="container-fluid">
      ...
      <a href="<?php echo get_site_url(); ?>/about-us/" class=" wow bounceIn" data-wow-duration="2s">Philosophy</a>
             </div>
         </div>
     </div>
 </section>
