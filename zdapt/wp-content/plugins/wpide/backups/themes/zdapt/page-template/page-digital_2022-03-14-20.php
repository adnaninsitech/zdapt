<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aecc07a13f087"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/page-template/page-digital.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/page-template/page-digital_2022-03-14-20.php") )  ) ){
...
<section class="cloud-computing" style="padding-bottom : 6%;" style="background-image : url(<?php echo the_field('bg_banner'); ?>);">
     <div class="container">
        <div class="row">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="slid">
            ...
            <img  data-wow-duration="2s" src="<?php echo get_sub_field('img'); ?>">
