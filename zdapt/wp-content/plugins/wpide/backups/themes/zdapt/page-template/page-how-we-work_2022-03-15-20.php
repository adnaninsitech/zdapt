<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "016ffb83721b25f471cd5d98ebce3aec30cd7a081b"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/themes/zdapt/page-template/page-how-we-work.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/zdapt/wp-content/plugins/wpide/backups/themes/zdapt/page-template/page-how-we-work_2022-03-15-20.php") )  ) ){
...
?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <table id="mytsable" class="table-responsive">
  <tr>
    <th>Features</th>
    <th>Fixed Price</th>
