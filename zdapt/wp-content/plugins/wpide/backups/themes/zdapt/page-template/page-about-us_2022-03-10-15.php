...
<section class="main-about">
    <div class="container">
        ...
        <div class="row">
            ...
            <h1  class="wow fadeInLeft" data-wow-duration="2s">Key Facts <span>About Us</span></h1>
...
if( have_rows('key_facts') ):
   ...
   $x=2; while( have_rows('key_facts') ) : the_row();
        ...
        ?>
             ...
             <div class="col-md-4  wow fadeInDown" data-wow-duration="<?php echo $x; ?>s">
                 <div class="box">
                     <h5><?php echo $year; ?></h5>
                     <p><?php echo $title; ?></p>
                 </div>
...
?>
        ...
        <div class="row why">
            <div class="col-md-12">
                <h1 class="wow fadeInLeft" data-wow-duration="2s"><span>Why work with us</span></h1>
                <ul>
                    <?php
...
?>
        ...
        <div class="row our-industry">
            <div class="col-md-12">
                 <h1 class="wow fadeInLeft" data-wow-duration="2s"><span>Our industry focus</span></h1>
...
?></h4></div>
        ...
        <div class="row powerful">
            ...
            <div class="col-md-12">
                <h1 class="wow fadeInLeft" data-wow-duration="2s"><span><?php echo the_field('middle_description', get_the_ID()); ?></span></h1>
            </div>
