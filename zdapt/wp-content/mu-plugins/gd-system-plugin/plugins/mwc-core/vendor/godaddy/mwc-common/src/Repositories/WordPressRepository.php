...
class WordPressRepository
{
     ...
     *
     * @TODO remove this deprecated method {unfulvio 2022-02-07}
     * @deprecated
     * @see WordPressRepository::getCurrentScreen()
     *
     * @return string|null
     */
    public static function getCurrentPage()
    {
        DeprecationHelper::deprecatedFunction(__METHOD__, '3.25', static::class.'::getCurrentScreen()');
     ...
     *
     * @TODO remove this deprecated method {FN 2022-02-07}
     * @deprecated
     * @see WordPressRepository::isCurrentScreen()
     *
    ...
    {
        DeprecationHelper::deprecatedFunction(__METHOD__, '3.25', static::class.'::isCurrentScreen()');
