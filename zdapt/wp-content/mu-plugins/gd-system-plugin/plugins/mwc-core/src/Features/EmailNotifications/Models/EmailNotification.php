...
class EmailNotification extends AbstractModel implements EmailNotificationContract
{
    ...
    /**
     * Checks whether the email notification is available (all dependencies are met and it's able to be enabled).
     *
     * By default notifications are always available. Specific notifications may override this.
     *
     * @return bool
     */
