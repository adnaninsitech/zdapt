...
trait IsDelayableEmailNotificationTrait
{
    ...
    {
        /* @TODO confirm the default value for the delay value {unfulvio 2022-03-09} */
        return $this->getSettingValue(GeneralSettings::SETTING_ID_DELAY_VALUE) ?: $this->defaultDelayValue;
    }
    ...
    {
        /* @TODO confirm the default value for the delay unit {unfulvio 2022-03-09} */
        return $this->getSettingValue(GeneralSettings::SETTING_ID_DELAY_UNIT) ?: $this->defaultDelayUnit;
    }
    ...
    {
        /* @TODO confirm the default value of the setting {unfulvio 2022-03-08} */
